...
___
### Getting Started
- Base URL: The project can only be run locally at the moment. The backend app is hosted by default at `http://127.0.0.1:5000`
...
### Error Handling
 ...
 ```
 The different types of error the API will return when requests fail are:
...
>`**GET/questions**`
  ...
  - Description:
    - Displays a list of questions paginated to 10 questions per page and showing current category,
      all categories as well as total number of questions
...
> `**DELETE/questions/{question_id}**`
  ...
  - Description:
    ...
    - Returns a respective deleted question id, a confirmation message, a success status value as well a paginated list of current questions
...
>`**GET/categories/{category_id}/questions**`
  ...
  - Description:
    ...
    - Recieves a request argument to select the page number. Results gotten are then paginated into groups of 10 each
...
>`##POST/quizzes`
  ...
  - `curl  -X POST -H "Content-Type: application/json" -d '{"quiz_category":{"type":"Science","id":"2"}, "previous_questions":[3]}'  http://127.0.0.1:5000/quizzes`
